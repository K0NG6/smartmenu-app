                    ...
                    <div class="col-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div id="accordion" ondragover='onDragOver(event);' ondrop='onDrop(event);'>

                                    @foreach ($dishes as $dish)
                                        <div class="card card-primary" id='draggablee{{$dish->id}}' draggable='true' ondragstart='onDragStart(event);'>
                                            <div class="card-header">
                                                <div class="row">
                                                    <div class="col-11">
                        ...
                        <div class="col-8">
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body" ondragover='onDragOver(event);' ondrop='onDrop(event);'>
                                    <!-- we are adding the accordion ID so Bootstrap's collapse plugin detects it -->
                                </div>
                            </div>
                        </div>
